    ...
    <div onClick={onClose} className='fixed inset-0 z-10 items-center flex justify-center p-4'>
      ...
      <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e) => e.stopPropagation()}>
        ...
        <div className='flex items-center justify-between p-6 pb-0'>
          ...
          <button onClick={onClose} className='text-slate-400 p-2 rounded-lg hover:bg-slate-100 transition-colors hover:text-slate-600'>
            <X className='w-5 h-5' />
          </button>
      </div>
      <form onSubmit={handleSubmit} className='p-6 space-y-5'>
          ...
          <div className='flex gap-3 pt-2'>
            ...
            <button type='submit' disabled={loading} className='btn-primary flex-1 flex items-center gap-2 justify-center'>
